...
@AllArgsConstructor
@PrimaryKeyClass
public class AuditEventByResourceKey implements Serializable {

    @PrimaryKeyColumn(name = "organization_id", type = PrimaryKeyType.PARTITIONED, ordinal = 0)
    private UUID organizationId;

    @PrimaryKeyColumn(name = "resource_type", type = PrimaryKeyType.PARTITIONED, ordinal = 1)
    private String resourceType;

    @PrimaryKeyColumn(name = "resource_id", type = PrimaryKeyType.PARTITIONED, ordinal = 2)
